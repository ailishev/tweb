...
const serverOptions: ServerOptions = {
  ...
  /**
   * Windows: Vite/chokidar can otherwise traverse the drive root and throw EINVAL on `pagefile.sys`.
   * Also avoids following stray junctions outside the repo.
   */
  ...(process.platform === 'win32' ?
    {
      watch: {
        ...
        ignored: [
          /(^|[\\/])(pagefile\.sys|hiberfil\.sys|swapfile\.sys)$/i,
